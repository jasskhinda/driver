...
export default function DriverTripsView({ user, trips: initialTrips = [] }) {
  ...
  const showCompleteConfirmation = (trip) => {
  ...
  const confirmCompleteTrip = async () => {
    ...
    try {
      console.log('Attempting to complete trip:', tripToComplete.id);
          ...
          <>
            ...
            {trip.status === 'in_progress' && (
              <>
                ...
                <button
                  onClick={() => showCompleteConfirmation(trip)}
                  className="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 font-medium"
                >
                  Complete Trip
                </button>
              ...
              <div className="mt-2 px-7 py-3">
                ...
                {tripToComplete && (
                  <div className="mt-2 p-2 bg-gray-50 rounded text-left">
                    <p className="text-xs text-gray-600">
                      <strong>Trip:</strong> {tripToComplete.pickup_address?.substring(0, 30)}...
                    </p>
                    <p className="text-xs text-gray-600">
                      <strong>To:</strong> {tripToComplete.destination_address?.substring(0, 30)}...
                    </p>
                  </div>
                )}
                <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                  ...
                  <p className="text-xs text-yellow-700 mt-1">
                    Once completed, you will not be able to change the trip status.
                  </p>
                </div>
              </div>
